...
(function(window, undefined) {
                    ...
                    if (match && (match[1] || !context)) {
                        ...
                        if (match[1]) {
                            ...
                            if (ret) {
                                ...
                                selector = jQuery.buildFragment([match[1]],
                                                                [doc]).childNodes;
                            }
                ...
                .extend({
                    ...
                    function(text) {
                        ...
                        return text == null ? "" : text.toString()
                                .replace(trimLeft, "").replace(trimRight, "");
                    },
                    ...
                    access: function(elems, key, value, exec, fn, pass) {
                        ...
                        if (value !== undefined) {
                            ...
                            for ( var i = 0; i < length; i++) {
                                fn(elems[i], key,
                                   exec ? value.call(elems[i], i, fn(elems[i],
                                                                     key))
                                       : value, pass);
                            }
                ...
                when: function(firstParam) {
                    ...
                    var args = sliceDeferred.call(arguments, 0), i = 0, length = args.length, pValues = new Array(
                                                                                                                  length), count = length, pCount = length, deferred = length <= 1 &&
                                                                                                                                                                       firstParam &&
                                                                                                                                                                       jQuery
                                                                                                                                                                               .isFunction(firstParam.promise) ? firstParam
                                                                                                                                                                                                              : jQuery
                ...
                try {
                    data = data === "true" ? true
                                          : data === "false" ? false
                                                            : data === "null" ? null
                                                                             : jQuery
                                                                                     .isNumeric(data) ? parseFloat(data)
                                                                                                     : rbrace
                                                                                                             .test(data) ? jQuery
                                                                                                                                .parseJSON(data)
                                                                                                                        : data;
    ...
    var rclass = /[\n\t\r]/g, rspace = /\s+/, rreturn = /\r/g, rtype = /^(?:button|input)$/i, rfocusable = /^(?:button|input|object|select|textarea)$/i, rclickable = /^a(?:rea)?$/i, rboolean = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, boolHook, fixSpecified;
            ...
            .extend({
                ...
                attr: function(elem, name, value, pass) {
                    ...
                    hooks = jQuery.attrHooks[name] ||
                            (rboolean.test(name) ? boolHook : undefined);
    ...
    var rformElems = /^(?:textarea|input|select)$/i, rtypenamespace = /^([^\.]*)?(?:\.(.+))?$/, rhoverHack = /\bhover(\.\S+)?\b/, rkeyEvent = /^key/, rmouseEvent = /^(?:mouse|contextmenu)|click/, rfocusMorph = /^(?:focusinfocus|focusoutblur)$/, rquickIs = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/, quickParse = function(
        ...
        return jQuery.event.special.hover ? events : events
                .replace(rhoverHack, "mouseenter$1 mouseleave$1");
    };
        ...
        trigger: function(event, data, elem, onlyHandlers) {
            ...
            if (!onlyHandlers && !event.isDefaultPrevented()) {
                ...
                if ((!special._default || special._default
                        .apply(elem.ownerDocument, data) === false) &&
                ...
                for (cur = event.target; cur != this; cur = cur.parentNode ||
                    ...
                    for (i = 0; i < delegateCount; i++) {
                        ...
                        if (selMatch[sel] === undefined) {
                            selMatch[sel] = (handleObj.quick ? quickIs(
                                                                       cur,
                                                                       handleObj.quick)
                                                            : jqcur.is(sel));
                        }
            ...
            setup: function() {
                ...
                jQuery.event.add(this, "beforeactivate._change", function(e) {
                    ...
                    if (rformElems.test(elem.nodeName) &&
                        ...
                        jQuery.event
                                .add(elem, "change._change", function(event) {
    ...
    (function() {
        ...
        var chunker = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|'(?:[^']|\\')*'|"(?:[^"]|\\")*"|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g, expando = "sizcache" +
                                                                                                                                                                                        (Math
                                                                                                                                                                                                ...
                                                                                                                                                                                                .replace(
                                                                                                                                                                                                         '.',
                                                                                                                                                                                                         ''), done = 0, toString = Object.prototype.toString, hasDuplicate = false, baseHasDuplicate = true, rBackslash = /\\/g, rReturn = /\r\n/g, rNonWord = /\W/;
        ...
        Sizzle.filter = function(expr, set, inplace, not) {
            ...
            var match, anyFound, type, found, item, filter, left, i, pass, old = expr, result = [], curLoop = set;
        ...
        var Expr = Sizzle.selectors = {
            ...
            relative: {
                "+": function(checkSet, part) {
                    ...
                    var isPartStr = typeof part === "string", isTag = isPartStr &&
                                                                      !rNonWord
                                                                              .test(part), isPartStrNotTag = isPartStr &&
                                                                                                             !isTag;
            ...
            filter: {
                ...
                ATTR: function(elem, match) {
                    ...
                    var name = match[1], result = Sizzle.attr(elem, name), value = result +
            ...
            .each(
                  ...
                  function(name, fn) {
                      ...
                      jQuery.fn[name] = function(until, selector) {
                          ...
                          return this.pushStack(ret, name, slice
                                  .call(arguments).join(","));
                      };
                  });
    ...
    var nodeNames = "abbr|article|aside|audio|canvas|datalist|details|figcaption|figure|footer|"
                    + "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", rinlinejQuery = / jQuery\d+="(?:\d+|null)"/g, rleadingWhitespace = /^\s+/, rxhtmlTag = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig, rtagName = /<([\w:]+)/, rhtml = /<|&#?\w+;/, rnoInnerhtml = /<(?:script|style)/i, rnocache = /<(?:script|object|embed|option|style)/i, rnoshimcache = new RegExp(
                                                                                                                                                                                                                                                                                                                                                                                                                                    "<(?:" +
                                                                                                                                                                                                                                                                                                                                                                                                                                            nodeNames +
                                                                                                                                                                                                                                                                                                                                                                                                                                            ")",
                                                                                                                                                                                                                                                                                                                                                                                                                                    "i"),
    ...
    jQuery.fn
            .extend({
                ...
                domManip: function(args, table, callback) {
                    ...
                    if (this[0]) {
                        fragment = jQuery.buildFragment(args, this);
        ...
        return function(dataTypeExpression, func) {
            ...
            if (jQuery.isFunction(func)) {
                var dataTypes = dataTypeExpression.toLowerCase()
                        .split(rspacesAjax), i = 0, length = dataTypes.length, dataType, list, placeBefore;
                ...
                return this.elements ? jQuery.makeArray(this.elements) : this;
                      ...
                      function() {
                          ...
                          return this.name &&
                                 !this.disabled &&
                                 (this.checked ||
                                  rselectTextarea.test(this.nodeName) || rinput
                                         .test(this.type));
                      }).map(
                             function(i, elem) {
                    ...
                    function doAnimation() {
                        ...
                        var opt = jQuery.extend({}, optall), isElement = this.nodeType === 1, hidden = isElement &&
                                                                                                       jQuery(
                                                                                                              this)
                                                                                                               .is(
                                                                                                                   ":hidden"), name, val, p, e, parts, start, end, unit, method;
    ...
    if ("getBoundingClientRect" in document.documentElement) {
        ...
        jQuery.fn.offset = function(options) {
            ...
            while ((elem = elem.parentNode) && elem !== body &&
                ...
                computedStyle = defaultView ? defaultView
                    ...
                    .css(elem, "top"), curCSSLeft = jQuery.css(elem, "left"), calculatePosition = (position === "absolute" || position === "fixed") &&
                                                                                                  jQuery
                                                                                                          .inArray(
                                                                                                                   ...
                                                                                                                   [
                                                                                                                           curCSSTop,
                                                                                                                           curCSSLeft]) > -1, props = {}, curPosition = {}, curTop, curLeft;
            ...
            .extend({
                ...
                position: function() {
                    ...
                    parentOffset.top += parseFloat(jQuery.css(offsetParent[0],
                                                              "borderTopWidth")) || 0;
                    parentOffset.left += parseFloat(jQuery
                            .css(offsetParent[0], "borderLeftWidth")) || 0;
            ...
            .each(
                  ...
                  function(i, name) {
                      ...
                      jQuery.fn["inner" + name] = function() {
                          ...
                          var elem = this[0];
                          return elem ? elem.style ? parseFloat(jQuery
                                                          .css(elem, type,
                                                               "padding"))
                                                  : this[type]()
                                     : null;
